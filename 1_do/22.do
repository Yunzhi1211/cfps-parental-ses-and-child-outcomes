/*==================================================
  CFPS 2022 Intergenerational Matching + Outlier Cleaning
...
*--- Raw data paths
local adult   "${RAW}\cfps2022person_202410.dta"
local famecon "${RAW}\cfps2022famecon_202410.dta"
...
flowappend, year(2022) step("Raw adult sample")
...
if _rc {
    egen info = rownonmiss( ///
        pid_a_f pid_a_m fid22 ///
        qg303code_isco qg303code_isei qg303code_siops qg303code_egp ///
        party age gender cfps2022eduy incomea urban22 provcd22 ///
...
flowappend, year(2022) step("Valid unique respondents")
...
preserve
    ...
    flowappend, year(2022) step("Intergenerational link identified")
restore

*—— Child basic characteristics
rename age              child_age
rename gender           child_gender
rename cfps2022eduy     child_edu
rename incomea          child_income
rename urban22          child_urban
rename provcd22         child_province
...
if _rc {
    egen info = rownonmiss( ///
        qg303code_isco qg303code_isei qg303code_siops qg303code_egp ///
        age gender cfps2022eduy incomea party urban22 provcd22 ///
        qc201 qea1 qea2 qga1 qga101 qu11 qu201 ///
        qn8011 qn8012 qn12012 qn12016 ///
        qp202 qp702n qq4010 qn4004 ///
        pt1 qs1001 qs502 qs801_b_2code )
...
rename cfps2022eduy     f_edu
rename incomea          f_income
rename urban22          f_urban
rename provcd22         f_province
...
keep ///
    ...
    qn12012 qn12016 ///
    qp202 qp702n qq4010 qn4004 ///
    qs801_b_2code pt1 qs1001 qs502
...
rename cfps2022eduy     m_edu
rename incomea          m_income
rename urban22          m_urban
rename provcd22         m_province
...
flowappend, year(2022) step("Matched to at least one parent")
...
preserve
    ...
    rename familysize22    family_size
    rename fswt_natcs22n   family_cs
...
preserve
    ...
    flowappend, year(2022) step("Matched to family economic data")
restore
...
preserve
    ...
    flowappend, year(2022) step("With child occupational outcome")
restore
...
compress
flowappend, year(2022) step("Yearly file saved")
save "${YOUT}\22_data.dta", replace
